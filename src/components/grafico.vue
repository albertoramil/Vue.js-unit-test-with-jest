<template>
  <div>
    <div>
      <trend
        :data="[0, 20, 5, 34, 15, 15, 35, 5, 50, 20, 1, 38, 20, 9, 50,10, 40, 20, 0]"
        :gradient="['#6fa8dc', '#42b983', '#2c3e59']"
        auto-draw
        smooth
      ></trend>
    </div>
    ...
    <div id="chart">
      <apexchart type="area" height="350" :options="chartOptionsN" :series="seriesN" />
    </div>

    <div id="chart">
    <apexchart type=line height=350 :options="chartOptionsT" :series="seriesT" />
  </div>
  ...
  <div id="chart">
    ...
    <apexchart type=area height=350 :options="chartOptionsL" :series="seriesL" />
  </div>
